...
// ✅ NEW: type matching the backend field `cfHandle`
...
interface StudentFormProps {
  open: boolean;
  onClose: () => void;
  onSubmit: (student: SubmitPayload, id?: number) => void;
      ...
      <div className="bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 p-4 sm:p-6 rounded shadow-lg w-full max-w-md mx-auto overflow-x-auto">
        ...
        <form
          onSubmit={(e) => {
            ...
            const payload: SubmitPayload = {
              ...
              email: form.email,
              phone: form.phone,
              cfHandle: form.codeforcesHandle,
        ...
        >
          ...
          <input
            ...
            onChange={(e) =>
              setForm((f) => ({ ...f, codeforcesHandle: e.target.value }))
            }
            required
          />
          <input
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-2 mt-4">
            <button
              type="button"
              className="px-4 py-2 rounded bg-gray-300 dark:bg-gray-600 text-gray-900 dark:text-gray-100 w-full sm:w-auto"
              onClick={onClose}
            >
              Cancel
            </button>
